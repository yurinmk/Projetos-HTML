function calcular(){
    ...
    switch(selecao){
        case 1:
            document.getElementById("resultado").innerHTML = "Valor da soma é: " + valores.reduce(somar);
            break;
        case 2:
            document.getElementById("resultado").innerHTML = "Valor da multiplicação é: " + valores.reduce(mult);
            break;
        case 3:
            document.getElementById("resultado").innerHTML = "Valor da divisão é: " +  valores.reduce(div);
            break;
        default:
